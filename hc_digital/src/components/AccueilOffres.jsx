    ...
    <section className="offres-section">
      <div className="offres-content">
        ...
        <p className="offres-text">
          Que vous soyez une startup, une PME ou une grande entreprise, HC Digital propose des formules adaptées à vos objectifs. De la création de site vitrine à la gestion de plateformes complexes, nos offres sont modulables et transparentes.
        </p>
