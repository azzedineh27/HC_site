    ...
    <section className="presentation-section">
      <div className="presentation-text-container">
        ...
        <p className="presentation-text">
          BuildCorp est une entreprise de solutions digitales qui repousse les
      ...
      <div className="presentation-image">
        <img src="./src/assets/qsn.jpg" alt="Présentation de BuildCorp" className="presentation-img" />
      </div>
    </section>
  );
};
